...
*
* This file includes the prototypes and documentation of functions for hack 13
*/

//This structure defines the parts of the Airport
typedef struct {
  char* gpsId;
  char* type;
  char* name;
...
//This comparator function is a base for the other functions (integers)
int cmpInt(const void *a, const void *b);

//This comparator function is a base for the other functions (doubles)
